...
| `settings.js`     | `GET/POST /settings/{properties,jvm-args,voicechat,ftbchunks}`, `GET/POST /config`, `GET /browse-dirs`, `POST /mkdir`, `GET /discord/status`, `POST /discord/{test-connection,test-notification,send-message}`, `GET /preflight` |
